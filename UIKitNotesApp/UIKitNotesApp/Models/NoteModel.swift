...
// 📄 FILE: NoteModel.swift (for UIKit)
// ==============================================================================
//
// 🧸 STORY TIME: WHAT IS A MODEL? (THE NOTE CARD BLUEPRINT)
// ------------------------------------------------------------------------------
// Imagine you are collecting baseball cards or Pokémon cards.
// Every card needs a consistent blueprint so you know what is written on it!
//
// In our UIKit app, NoteEntity is the MODEL layer. It defines what a single
// Note Card looks like in computer memory and in Core Data storage.
//
...
// 12.'displayDate'      -> Helper that turns raw computer time into friendly words like "Aug 24, 2026".
// ==============================================================================
