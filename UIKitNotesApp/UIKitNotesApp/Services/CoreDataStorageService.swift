...
// 📄 FILE: CoreDataStorageService.swift (for UIKit)
// ==============================================================================
//
...
class CoreDataStorageService {
    ...
    init(inMemory: Bool = false) {
        ...
        container.loadPersistentStores { description, error in
            if let error = error {
                print("Uh-oh! Could not open UIKit database: \(error.localizedDescription)")
            } else {
                print("Yay! UIKit database is open and ready to use!")
            }
        }
    }
    ...
    func saveContext() {
        if context.hasChanges {
            do {
                try context.save()
                print("Success! UIKit note changes were saved to permanent storage!")
            } catch {
                print("Oops! Could not save UIKit notes: \(error.localizedDescription)")
            }
        }
    }
}
