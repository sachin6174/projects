...
// 📄 FILE: AppDelegate.swift (for Storyboard UIKit)
// ==============================================================================
//
...
// When using Storyboards, the AppDelegate works seamlessly with the Scene configuration
// so iOS knows how to unpack Main.storyboard onto the screen.
//
// ==============================================================================
...
// 9. 'launchOptions'          -> A dictionary of clues about WHY the app was opened.
...
// 12.'UISceneConfiguration'   -> Instructions on which SceneDelegate and Storyboard will build the window.
// ==============================================================================
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // and automatically load Main.storyboard!
    func application(
        _ application: UIApplication,
